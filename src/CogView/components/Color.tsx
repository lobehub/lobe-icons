...
const Icon: IconType = forwardRef(({ size = '1em', style, ...rest }, ref) => {
  ...
  return (
    ...
    >
      <title>{TITLE}</title>
      <path d="M15.271 16.555l5.72 4.877s-3.276 3.125-7.223-2.866l1.503-2.01z" fill={a.fill}></path>
      <path d="M15.4 16.523l4.596 5.947s-3.85 2.39-6.477-4.293l1.882-1.654z" fill={b.fill}></path>
      <path
      ...
      <path
        ...
        fill={j.fill}
      ></path>
      <path d="M11.79 8.077a2.909 2.909 0 100-5.817 2.909 2.909 0 000 5.817z" fill={k.fill}></path>
      <path
      ...
      <path
        ...
        fill={r.fill}
      ></path>
      <path d="M13.757 6.412a1.492 1.492 0 100-2.984 1.492 1.492 0 000 2.984z" fill={s.fill}></path>
      <path
      ...
      <path
        ...
        fill={y.fill}
      ></path>
      <path d="M13.52 5.504a.724.724 0 100-1.449.724.724 0 000 1.449z" fill={z.fill}></path>
      <path
        d="M13.357 5.169c.257 0 .465-.223.465-.498 0-.274-.208-.497-.465-.497s-.465.223-.465.497c0 .275.208.498.465.498z"
        fill={A.fill}
      ></path>
      <path d="M13.681 4.423a.108.108 0 100-.217.108.108 0 000 .217z" fill="#fff"></path>
      <defs>
        <linearGradient
          ...
          y2="20.083"
        >
          <stop offset=".006" stopColor="#E8096A"></stop>
          <stop offset="1" stopColor="#00AFFF"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={c.id}
          ...
          y2="1.932"
        >
          <stop stopColor="#412DF5"></stop>
          <stop offset=".691" stopColor="#0606B6"></stop>
          <stop offset="1" stopColor="#4B00B4"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={d.id}
          ...
          y2="4.518"
        >
          <stop stopColor="#E60030"></stop>
          <stop offset="1" stopColor="#690040"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={e.id}
          ...
          y2="6.013"
        >
          <stop stopColor="#FF6500"></stop>
          <stop offset="1" stopColor="#EE182C"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={f.id}
          ...
          y2="8.699"
        >
          <stop stopColor="#EA4D07"></stop>
          <stop offset="1" stopColor="#C5171E"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={g.id}
          ...
          y2="18.02"
        >
          <stop stopColor="#0091FF"></stop>
          <stop offset=".005" stopColor="#0292FC"></stop>
          <stop offset=".126" stopColor="#37A5C2"></stop>
          <stop offset=".249" stopColor="#65B58E"></stop>
          <stop offset=".372" stopColor="#8CC363"></stop>
          <stop offset=".496" stopColor="#ACCF3F"></stop>
          <stop offset=".62" stopColor="#C4D823"></stop>
          <stop offset=".745" stopColor="#D6DE10"></stop>
          <stop offset=".871" stopColor="#E1E204"></stop>
          <stop offset="1" stopColor="#E4E300"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={h.id}
          ...
          y2="18.4"
        >
          <stop offset=".006" stopColor="#DE003B"></stop>
          <stop offset=".241" stopColor="#D976FF"></stop>
          <stop offset="1" stopColor="#00A4EA"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={l.id}
        ...
        >
          ...
          <stop offset="1" stopColor="#F7FF2B"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={m.id}
          ...
          y2="8.476"
        >
          <stop offset=".207" stopColor="#FF8E00"></stop>
          <stop offset="1" stopColor="#F41B56"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={o.id}
          ...
          y2="6.584"
        >
          <stop stopColor="#FFB41F"></stop>
          <stop offset="1" stopColor="#F42A56"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={p.id}
          ...
          y2="6.928"
        >
          <stop stopColor="#FFB900"></stop>
          <stop offset="1" stopColor="#F41880"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={r.id}
        ...
        <linearGradient
          ...
          y2="2.03"
        >
          <stop stopColor="#008DFF"></stop>
          <stop offset=".181" stopColor="#331DEA"></stop>
          <stop offset=".833" stopColor="#39C3FE"></stop>
          <stop offset="1" stopColor="#60F5A9"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={w.id}
        ...
        <linearGradient
          ...
          y2="5.699"
        >
          <stop stopColor="#FFD71F"></stop>
          <stop offset="1" stopColor="#DD001B"></stop>
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          id={y.id}
          ...
          y2="6.603"
        >
          <stop offset="0" stopColor="#FF4C00"></stop>
          <stop offset="1" stopColor="#FFFF1E"></stop>
        </linearGradient>
        <radialGradient
          cx="0"
          cy="0"
          ...
          r="1"
        >
          <stop stopColor="#00CAFF"></stop>
          <stop offset="1" stopColor="#38E700"></stop>
        </radialGradient>
        <radialGradient
          cx="0"
          cy="0"
          ...
          r="1"
        >
          <stop stopColor="#00DFFF"></stop>
          <stop offset="1" stopColor="#ABE700"></stop>
        </radialGradient>
        <radialGradient
          cx="0"
          cy="0"
          ...
          r="1"
        >
          <stop stopColor="#0068FF"></stop>
          <stop offset="1" stopColor="#9CE830"></stop>
        </radialGradient>
        <radialGradient
          cx="0"
          cy="0"
          ...
          r="1"
        >
          <stop stopColor="#008A43"></stop>
          <stop offset="1" stopColor="#A3E830"></stop>
        </radialGradient>
        <radialGradient
          cx="0"
          cy="0"
        ...
        <radialGradient
          ...
          r="1"
        >
          <stop offset=".001" stopColor="#72003F"></stop>
          <stop offset="1" stopColor="#CA1D67"></stop>
        </radialGradient>
        <radialGradient
          cx="0"
          cy="0"
          ...
          r="1"
        >
          <stop offset="0" stopColor="#D1DEE7"></stop>
        ...
        <radialGradient
          ...
          r="1"
        >
          <stop offset=".001" stopColor="#7F06FB"></stop>
          <stop offset="1" stopColor="#7A10FB" stopOpacity="0"></stop>
        </radialGradient>
        <radialGradient
          cx="0"
          cy="0"
          ...
          r="1"
        >
          <stop offset=".001" stopColor="#FF0042"></stop>
          <stop offset=".422" stopColor="#0068FF"></stop>
          <stop offset=".659" stopColor="#1877E2"></stop>
          <stop offset="1" stopColor="#4EEFBE"></stop>
        </radialGradient>
        <radialGradient
          cx="0"
          cy="0"
          ...
          r="1"
        >
          <stop stopColor="#FF9100"></stop>
          <stop offset=".226" stopColor="#FF9500"></stop>
          <stop offset=".443" stopColor="#FEA000"></stop>
          <stop offset=".657" stopColor="#FCB400"></stop>
          <stop offset=".867" stopColor="#F9CF00"></stop>
          <stop offset="1" stopColor="#F7E400"></stop>
        </radialGradient>
        <radialGradient
          cx="0"
          cy="0"
        ...
        >
          <stop></stop>
          <stop offset=".092" stopColor="#000004"></stop>
          <stop offset=".177" stopColor="#01000F"></stop>
          <stop offset=".258" stopColor="#020021"></stop>
          <stop offset=".338" stopColor="#03003C"></stop>
          <stop offset=".417" stopColor="#05005D"></stop>
          <stop offset=".494" stopColor="#080087"></stop>
          <stop offset=".571" stopColor="#0A00B8"></stop>
          <stop offset=".645" stopColor="#0E00F0"></stop>
          <stop offset=".654" stopColor="#0E00F7"></stop>
        </radialGradient>
      </defs>
    </svg>
  );
