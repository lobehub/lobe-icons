...
const Icon: IconType = forwardRef(({ size = '1em', style, ...rest }, ref) => {
  return (
    ...
    >
      <title>{TITLE}</title>
      <path d="M59.34 2.062a2.05 2.05 0 01-2.072 2.061c-1.18 0-2.1-.903-2.1-2.061S56.088 0 57.268 0a2.05 2.05 0 012.071 2.062zM58.878 21.746h-3.28V6.185h3.28v15.56zM13.249 21.746h3.25v-9.179c0-4.349-2.79-6.636-6.501-6.636-1.899 0-3.654.762-4.718 2.033v-1.78H2v15.562h3.28v-8.699c0-2.852 1.582-4.32 3.999-4.32 2.387 0 3.97 1.468 3.97 4.32v8.699z"></path>
      <path
        clipRule="evenodd"
      ...
      ></path>
      <path d="M43.169 21.746L37.156 6.185h3.51l4.488 12.68 4.488-12.68h3.48l-6.04 15.56h-3.913zM68.286 21.746c-2.82 0-4.575-1.158-4.575-4.321V8.81h-1.87V6.185h1.87v-3.87h3.309v3.87h3.855V8.81H67.02v8.614c0 1.158.46 1.638 1.84 1.638h2.015v2.683h-2.589z"></path>
      <path
        clipRule="evenodd"
      ...
      ></path>
      <path d="M94.725 17.82a2.05 2.05 0 012.071 2.062 2.05 2.05 0 01-2.071 2.062c-1.18 0-2.1-.904-2.1-2.062s.92-2.062 2.1-2.062z"></path>
      <path
        clipRule="evenodd"
      ...
      ></path>
      <path d="M121.508 4.123a2.05 2.05 0 002.071-2.061A2.05 2.05 0 00121.508 0c-1.18 0-2.1.904-2.1 2.062s.92 2.061 2.1 2.061zM119.839 21.746h3.279V6.185h-3.279v15.56z"></path>
    </svg>
  );
});
