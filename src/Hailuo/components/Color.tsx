    ...
    >
      ...
      <defs>
        <linearGradient
          ...
          y2="27.022"
        >
          <stop offset=".09" stopColor="#FFAB0C"></stop>
          <stop offset=".31" stopColor="#FF5538"></stop>
          <stop offset=".46" stopColor="#E9405D"></stop>
          <stop offset=".75" stopColor="#D266DA"></stop>
          <stop offset=".89" stopColor="#D584EF"></stop>
        </linearGradient>
      </defs>
    </svg>
  );
